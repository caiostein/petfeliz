    ...
    <div id="listaAnimais">         
        <br>
          <ul class="collection with-header">
             <li class="collection-header"><h4>Outros Animais Registrados</h4> 
             ...
             <router-link to="/animaisCachorro" class="waves-effect waves-light btn-small"
                  ...
                  class="waves-effect waves-light btn-small disabled" >Outros</router-link>
    ...
    name: "listaAnimais",
        ...
        created(){
            ...
            firebase.auth().onAuthStateChanged((user) => {
                if(user){
                    db.collection('abrigo').doc(user.uid).collection('animal').where("tipo", "==", "Outro")
                        .get()
                        .then(querrySnapshot=>{
